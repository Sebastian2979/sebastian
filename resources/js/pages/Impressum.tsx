    ...
    return (
        <div className='flex justify-center items-center min-h-screen p-4'>
            <div className="max-w-5xl mx-auto">
                ...
                <p className="mb-2"><strong>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</strong></p>
                <p>Sebastian Kitschke</p>
                <p>[ Adresse wie oben ]</p>
                <p className="mt-4 mb-2"><strong>Haftungsausschluss - Disclaimer:</strong></p>
                ...
                <p className="mb-2"><strong>Haftung für Links</strong></p>
                ...
                <p className="mb-2"><strong>Urheberrecht</strong></p>
